<script lang="ts">
	...
	import '../app.css';
	/*
	 * The props rune in svelte allows us to pass data from a component down to its children
	 * Here we get 'children' from SvelteKit – it's a function that renders the current route's content.
